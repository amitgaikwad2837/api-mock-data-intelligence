# v0.1 Engineering Backlog - API Mock Data Intelligence

## 1. Release Objective

- Product Type: CLI
- Primary Command/API: mock-data-gen
- v0.1 Goal: Generate realistic relational mock datasets including edge and bad-data cases.
...
domain schema, scale settings, locale rules

### Outputs

json/csv datasets with relation integrity report
...
- Core Acceptance Test: Given commerce schema fixture, output includes valid user-order relations and configured edge cases.
